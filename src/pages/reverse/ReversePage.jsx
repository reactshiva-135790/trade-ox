...
const ReversePage = (props) => {
    ...
    const reverseFunction = async (inputValue, inputValueOne) => {
    ...
    const renderButton = () => {
        if (!responseStatus) {
            ...
            return <Button variant="warning text-light" className="bofjak mt-2"
                ...
                onClick={() => reverseFunction(inputValue, inputValueOne)}
            >
                Reverse LP
                    ...
                    <div className="col-xxl-6 offset-xxl-3 col-xl-6
                        ...
                        <div className="swap-pa shadow p-3 mb-5 bg-body-tertiary rounded">
                            <div className="bDoIUK">
                                Trade tokens in an instant Reverse
                            </div>
                            <div>
                                <h3
